"""
Generates all T-MEDNet plots for Medes (site 6):
  T-Cycle, Anomaly, Stratification, Thresholds 23-27°C  (per year)
  Database_T .zip  +  Stat_Report .xlsx  (merged full history)

Data sources:
  Historical DB:   Downloads/Database_T_06_Medes_200207-202510_2025-11-04.zip
  HOBO campaign:   Downloads/Medes  (Oct 27 2025 – May 25 2026, depths 5-35 m)

Output:  Desktop/temperatures t-mednet/Medes/
           2025/  -->  T-Cycle, anomaly, stratification, thresholds 23-27°C
           2026/  -->  T-Cycle, anomaly, stratification
           Database_T_6_Medes_200207-202605_<date>.zip
           6_Stat_Report_Medes_200207-202605_<date>.xlsx
"""
...
def read_database_t_zip(zip_path):
    tmp = os.path.join(os.environ['TEMP'], '_medes_hist_extract')
